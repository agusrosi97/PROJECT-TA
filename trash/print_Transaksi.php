      ...
      <div class="row">
        <div class="col-md-12">
          <div class="page-header clearfix">
            <h2 class="text-center pt-3">LAPORAN TRANSAKSI</h2>
          </div>
          ...
          $sql = "SELECT tbl_reservasi.*, tbl_tamu.*, tbl_pengguna.*, tbl_transaksi_pembayaran.*
                  ...
                  LEFT JOIN tbl_transaksi_pembayaran ON tbl_reservasi.id_reservasi = tbl_transaksi_pembayaran.id_reservasi
        ...
        <div class="col">
          <p><b><h5>Total transaksi : Rp.9.600.000,-</h5></b></p>
        </div>

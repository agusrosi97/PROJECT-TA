		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					...
					if (!empty($_SESSION['tglawalCheckout']) AND !empty($_SESSION['tglakhirCheckout'])) {
						$sql = "SELECT tbl_tamu.*, tbl_reservasi.*, tbl_transaksi_pembayaran.* FROM tbl_transaksi_pembayaran INNER JOIN tbl_tamu ON tbl_transaksi_pembayaran.id_tamu = tbl_tamu.id_tamu INNER JOIN tbl_reservasi ON tbl_transaksi_pembayaran.id_reservasi = tbl_reservasi.id_reservasi WHERE tgl_checkout BETWEEN DATE('".$_SESSION['tglawalCheckout']."') AND DATE('".$_SESSION['tglakhirCheckout']."') GROUP BY tbl_tamu.email_tamu";
					}
					else{

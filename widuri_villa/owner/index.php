<?php 
  ...
  // cekKaryawan
  $cekKaryawan = mysqli_query($conn, "SELECT * FROM tbl_pengguna WHERE hak_akses_pengguna != 'owner' AND status_pengguna = 'Aktif'");
  $OutputKaryawan = mysqli_num_rows($cekKaryawan);
  $earliest_year = 2017;
?>
<!doctype html>
        ...
        <div class="row px-2">
          <div class="col-sm-12 mb-2">
            <div class="card-group">
              <div class="card col-md-6 no-padding border-0 mb-2 bg-flat-color-2 mr-lg-1 rounded shadow-sm dash-card" onclick="window.location.href='tabel_tipeKamar.php'">
                <div class="card-body">
                  <div class="h1 text-light text-right mb-4">
                    <i class="fas fa-users-cog"></i>
                  </div>
                  <div class="h5 mb-0 text-light">
                    <span class="count"><?=$OutputKaryawan;?></span>
                  </div>
                  <small class="text-light text-uppercase font-weight-bold">Jumlah karyawan</small>
                  <div class="progress progress-xs mt-3 mb-0" style="width: 40%; height: 5px;"></div>
                </div>
              </div>
              <div class="card col-md-6 no-padding border-0 mb-2 bg-flat-color-10 mx-lg-1 rounded shadow-sm dash-card tam">
              ...
              <div class="card col-md-6 no-padding border-0 mb-2 bg-flat-color-9 ml-lg-1 rounded shadow-sm dash-card trans">
                ...
                <div class="card-body" onclick="window.location.href='tabel_transaksi.php'">
                  ...
                  <div id="tampilHasilTrans" >
                    <div class="h5 mb-0 text-light">
                      <span class="">Rp.<?= number_format($hasilTransaksi['total_bayar'],0,',','.');?>,-</span>
                    </div>
      ...
      <div class="content mb-4">
        <div class="row mb-4 px-2">
          <div class="col-lg-6 pr-lg-1">
            <div class="card rounded border border-light mb-3 shadow">
          ...
          <div class="col-lg-6 pl-lg-1">
            <div class="card grafiktrans rounded shadow border-light mb-3">
          ...
          <div class="col-lg-6 pr-lg-1">
            <div class="card shadow rounded border-light mb-3">
              ...
              <div class="card-body pt-1" style="overflow-y: auto; height: 240px">

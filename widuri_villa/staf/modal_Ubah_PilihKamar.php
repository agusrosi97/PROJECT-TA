  ...
  <div class="modal-dialog modal-dialog-scrollable shadow modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="">
          ...
          <div class="form-group row">
            <label for="nmtamu<?=$no;?>" class="col-md-2 col-form-label">Nama Tamu :</label>
            <div class="col-md-6">
            ...
            <div class="col-md-4">
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="total_hargaa" readonly style="font-weight: bold; font-size: 20px" name="total_hargaa" value="0">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-5 right-border">
              ...
              <div class="form-group">
                <label for="TMM">Tanggal Checkin <sup class="harus-isi">*</sup></label>
                <input id="TMM" class="form-control pem" type="text" name="inp_CekIn" onchange="hitung2(); disableCheck2();" readonly value="<?=$row['tgl_checkin'] ?>">
              </div>
              <div class="form-group">
                <label for="TKK">Tanggal Checkout <sup class="harus-isi">*</sup></label>
                <input id="TKK" class="form-control pem" type="text" name="inp_CekOut" onchange="hitung2(); disableCheck2()" readonly value="<?=$row['tgl_checkout'] ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" id="jumlahHarii" name="total_tanggal" class="form-control inputangka" readonly value="<?=$row['jumlah_hari'] ?>">
              </div>
              <div class="form-group">
                <label for="jmlKamarr">Jumlah kamar</label>
                <input type="text" id="jmlKamarr" class="form-control" name="jumlah_kamar" readonly value="0">
              </div>
            </div>
            <div class="col-md-7">
              ...
              <?php
                $i = 1;
                while ($rowTK = mysqli_fetch_array($queryKamar)) : ?>
                  <div class="form-row border-bottom">
                    <div class="form-group col-md-1 d-flex align-self-center mb-0 mr-2">
                      <div class="checkbox-custom" data-toggle="tooltip" data-placement="top" title="klik untuk memilih" style="line-height: 1">
                        <label style="font-size: 1.5em;" class="d-flex justify-content-center align-items-center mb-0 forrup" onchange='hitung2();'>
                          <input id="btnKamarr_<?=$i;?>" type="checkbox" value="<?php echo $rowTK['id_tipe_kamar'] ?>" name="id_kamar[]">
                          <span class="cr" tabindex="-1"><i class="cr-icon fa fa-check"></i></span>
                        </label>
                      </div>
                    </div>
                    <div class="form-group col-md-5 mb-1">
                      <label for="btnKamarr_<?=$i;?>" class="form-control border-0 pl-0" onchange='hitung2();'><h4><?=$rowTK["nama_tipe_kamar"] ?></h4></label>
                      <label for="btnKamarr_<?=$i;?>" onchange='hitung2();'><p class="mb-0 pb-0">Rp.<?=number_format($rowTK["harga_kamar"],2,',','.')?>,-</p></label>
                      <input type="hidden" id="hargaPerKamarr<?=$i?>" value="<?php if($rowTK['harga_kamar'] <= 0) : ?>0<?php else : ?><?= $rowTK['harga_kamar'] ?><?php endif; ?>">
                    </div>
                    <div class="form-group col-md-5">
                      <label for="Kamarr<?=$i?>">Jumlah kamar</label>
                      <select name="jumlahKamarPerPilihan[]" class="form-control" onchange='hitung2();' id="Kamarr<?=$i?>" disabled>
                        <?php
                          $j = 0;
      ...
      <div class="modal-footer text-center justify-content-center">
        ...
        <button type="submit" class="btn btn-primary rounded" id="btnPesan_reservasii" name="submitEditReservasi">Simpan</button>
      </div>
        </form>
    </div>
  </div>

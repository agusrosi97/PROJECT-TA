  ...
  <div class="modal-dialog modal-dialog-scrollable shadow" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalScrollableTitle">Tambah Data Pengguna</h5>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
          <div class="form-row">
            <div class="form-group col-md-7">
              ...
              <input id="insNama_Owner" class="form-control" type="text" name="inp_nama_pengguna" placeholder="Nama Pengguna" required>
            </div>

            <div class="form-group col-md-5">
              <label for="insTglLahir_Owner">Tanggal lahir <sup class="harus-isi">*</sup></label>
              <input id="insTglLahir_Owner" class="form-control" type="date" name="inp_tgllahir_pengguna" required>
            </div>

            <div class="form-group col-md-7">
              <label for="insEmail_Owner">Email <sup class="harus-isi">*</sup></label>
              <input id="insEmail_Owner" class="form-control" type="email" name="inp_email_pengguna" placeholder="Email Pengguna" required>
            </div>
            
            <div class="form-group col-md-5">
              <label for="insTlp_Owner">No Telp <sup class="harus-isi">*</sup></label>
              <input id="insTlp_Owner" class="form-control" type="number" name="inp_tlp_pengguna" placeholder="Telepon Pengguna" required>
            </div>

            <div class="form-group col-md-6">
              <label for="insLEvel_Owner">Hak Akses</label>
              <select name="inp_akses_pengguna" id="insLEvel_Owner" class="form-control">
            ...
            <div class="form-group col-md-6">
              ...
              <select id="insJK_Owner" class="form-control" name="inp_jk_pengguna">
            ...
            <div class="form-group col-md-12">
              ...
              <textarea id="insAlamat_Owner" class="form-control" placeholder="Alamat Tamu" name="inp_alamat_pengguna" required></textarea>
            </div>

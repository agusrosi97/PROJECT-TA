                    ...
                    <div class="row">
                      ...
                      <div class="col-5 pl-0">
                        <div class="form-row pt-sm-3 pr-1">
                          ...
                          <select id="Kamar<?= $i ?>" class="form-control inputangka col-md-8" disabled="true" form="form_reservasi">
                            <?php
                              $j = 0;
    ...
    <script type="text/javascript">
      ...
      <?php foreach ($dataTipeKamar as $key): ?>
        $('.inputangka').on('change',function(){
          ...
          var JmlKamar3 = Number($('#Kamar3').val());
          var JmlHari = document.getElementById('jumlahHari').value;
          var hargaKamar_tipe1 = Number($('#hargaPerKamar1').val());
          var hargaKamar_tipe2 = Number($('#hargaPerKamar2').val());
          var hargaKamar_tipe3 = Number($('#hargaPerKamar3').val());
          // var TotHarga = JmlHari;
          var TotHarga = JmlKamar1 * hargaKamar_tipe1 + JmlKamar2 * hargaKamar_tipe2 + JmlKamar3 * hargaKamar_tipe3 * JmlHari;

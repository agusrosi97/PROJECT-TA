        ...
        <form method="POST" action="" enctype="multipart/form-data">
          ...
          <div class="form-row">
            ...
            <div class="form-group position-relative wrapper-inp-register col-md-5">
              ...
              <input id="tamu_tgl" type="text" class="form-control pem register-inp" name="inp_tgllahir_tamu" required readonly placeholder="Tanggal lahir">
              <span class="inp-focus"></span>
            </div>
      ...
      echo "
        <script>
          Swal.fire({
            ...
            window.location.href = '../tamu/register.php';
          })
        </script>
      ";
    }
